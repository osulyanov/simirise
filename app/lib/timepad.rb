...
class Timepad
  ...
  # "tickets"=>[
    ...
    # "price_nominal"=>"1200",
    # "answers"=>{"mail"=>"sosiska_38@rambler.ru", "surname"=>"Шустова", "name"=>"Марианна", "phone"=>"+7 (926) 934-49-59"}, "ticket_type"=>{"id"=>2467638, "name"=>"Single ticket (1st release)", "description"=>"* Цена билета действительна на день оплаты. По мере приближения к мероприятию стоимость билета увеличивается.", "buy_amount_min"=>1, "buy_amount_max"=>30, "price"=>1500, "is_promocode_locked"=>false, "remaining"=>91, "sale_ends_at"=>"2019-05-14T12:00:00+0300", "is_active"=>true, "ad_partner_profit"=>0, "send_personal_links"=>true, "status"=>"late"}, "attendance"=>{}, "place"=>{}, "codes"=>{"ean13"=>"1000277814569", "ean8"=>"27781456", "printed_code"=>"1000277814569"}, "personal_link"=>false}],
  # "promocodes"=>{},
  # "referrer"=>{"campaign"=>"Переходы с сайтов", "medium"=>"Переходы с сайтов", "source"=>"www.facebook.com"},
  # "subscribed_to_newsletter"=>false,
  # "meta"=>{"request_snapshot"=>{"res"=>{"2467638"=>"1"}, "user_forms"=>[{"mail"=>"sosiska_38@rambler.ru", "surname"=>"Шустова", "name"=>"Марианна", "phone"=>"+7 (926) 934-49-59"}], "accepted_terms"=>"on", "tickets"=>[{"re_id"=>"2467638"}], "locale"=>"ru", "ga_cid"=>"1418962617.1556818047", "aux"=>{"use_ticket_remind"=>"1"}, "referer"=>"https://www.facebook.com/", "stat_metadata"=>{"event_id"=>"971757", "org_id"=>"65132", "event_cats"=>"457", "reg_count"=>"1", "questions_count"=>"4", "max_price"=>"0", "from"=>"isInTimepad", "widget_mode"=>"default", "widget_id"=>"", "widget_consumer_url"=>"https://application.timepad.ru/event/971757/?fbclid=IwAR2d3Q1B1p4Vxfy-NKsHzHyOEN_czw4qTYDTvFLS0mNCLxyd-9mYmYXmJxg", "use_multireg"=>"true", "widget_use_multiank"=>"false"}},
